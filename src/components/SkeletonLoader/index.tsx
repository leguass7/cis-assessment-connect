...
export const SkeletonLoader = () => {
  ...
  return (
    <Stack mt={10} spacing={4}>
      ...
      <Skeleton width="80%" height="26px" borderRadius="lg" endColor={skeletonColorEnd} startColor={skeletonColorStart} />
      <Skeleton width="60%" height="26px" borderRadius="lg" endColor={skeletonColorEnd} startColor={skeletonColorStart} />
      <Skeleton width="70%" height="200px" borderRadius="lg" endColor={skeletonColorEnd} startColor={skeletonColorStart} />
    </Stack>
  );
};
