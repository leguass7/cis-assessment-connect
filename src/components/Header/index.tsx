      ...
      <Flex width="100%" alignItems="center" justifyContent="space-between">
        <Stack py={2} width="100%" align="center" gap={{ base: 0, md: 4 }} direction={{ base: 'column', md: 'row' }}>
          ...
          <Flex gap={2} width="100%" align={'center'} marginTop={{ base: 5, md: 0 }} justify={{ base: 'center', md: 'end' }}>
            ...
            <Link passHref legacyBehavior href="https://back.aws.cisassessment.com.br/api/v1/docs-api/">
            ...
            <Link passHref legacyBehavior href="https://github.com/CIS-Assessment/cis-assessment-app">
              <a target="_blank" rel="noopener noreferrer">
